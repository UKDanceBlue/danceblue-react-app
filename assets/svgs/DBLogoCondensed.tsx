...
const DBLogoCondensed = ({
  ...
  >
    ...
    <Path
      // @ts-expect-error This works
      style={{ fill: ribbonColor ?? "#FFC72C" }}
      d="M239.92 364.44c-.87-1.17-1.52-2.47-2.06-3.82 1.02 1.1 1.48 2.49 2.06 3.82zM237.63 360.16a13.01 13.01 0 0 1-1.68-3.14c.94.85 1.19 2.06 1.68 3.14zM242.96 370.47c-.26-.77-.86-1.37-1.01-2.18.75.53.88 1.4 1.19 2.18l-.03.02c-.05-.02-.1-.03-.15-.02zM241.47 367.35c-.42-.21-.41-.7-.65-1.02.36.24.74.48.65 1.02zM235.47 356.09c-.24.04-.2-.39-.48-.28.02-.24.05-.47.07-.71.24.28.51.56.41.99z"
    />
    <Path
      // @ts-expect-error This works
      style={{ fill: ribbonColor ?? "#FFC72C" }}
    ...
    <Path
      // @ts-expect-error This works
      style={{ fill: ribbonColor ?? "#FFC72C" }}
      d="M235.96 357.04c-.26-.08-.27-.28-.25-.5.28.07.34.24.25.5zM237.87 360.64c-.26-.07-.26-.28-.26-.48.32.03.33.23.26.48zM241.71 367.83c-.26-.08-.26-.28-.25-.5.3.06.3.27.25.5z"
    />
    <Path
      // @ts-expect-error This works
      style={{ fill: ribbonColor ?? "#FFC72C" }}
      d="M241.95 368.3c-.21-.1-.28-.27-.26-.49.3.06.35.24.26.49zM243.46 370.85c-.11.02-.23.04-.34.05 0-.14 0-.28-.01-.42l.03-.02c.25.01.27.22.32.39z"
    />
    <Path
      // @ts-expect-error This works
      style={{ fill: ribbonColor ?? "#FFC72C" }}
    ...
    <Path
      // @ts-expect-error This works
      style={{ fill: letterColor ?? "#0032A0" }}
      d="M227.8 268.07c-.64-.01-1.28-.01-1.91-.02.64-.28 1.28-.31 1.91.02zM230.91 268.07c-.31 0-.63-.01-.94-.01.31-.29.62-.26.94.01z"
    />
    <Path
      // @ts-expect-error This works
      style={{ fill: letterColor ?? "#0032A0" }}
