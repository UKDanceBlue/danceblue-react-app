import { Box, Heading, ScrollView, Text, useTheme, View } from "native-base";
...
const SponsorsBlock = () => {
  ...
  const {primary, secondary, tertiary, success, warning, error, danger} = useThemeColors();
